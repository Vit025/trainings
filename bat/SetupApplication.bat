...
:: Android packaging
set AND_CERT_NAME="GITTrainings"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\GITTrainings.p12
...
set IOS_PROVISION=cert\GITTrainings.mobileprovision
...
set APP_ID=air.com.tessmann.trainings.GITTrainings

:: Output packages
set DIST_PATH=dist
set DIST_NAME=GITTrainings
